...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, setHeader, getHeader, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://D:/Work/home-fashion-web/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/Work/home-fashion-web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/Work/home-fashion-web/node_modules/devalue/index.js';
import destr from 'file://D:/Work/home-fashion-web/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase } from 'file://D:/Work/home-fashion-web/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/Work/home-fashion-web/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/Work/home-fashion-web/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/Work/home-fashion-web/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/Work/home-fashion-web/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://D:/Work/home-fashion-web/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/Work/home-fashion-web/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/Work/home-fashion-web/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/Work/home-fashion-web/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Work/home-fashion-web/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/Work/home-fashion-web/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/Work/home-fashion-web/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Work/home-fashion-web/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file://D:/Work/home-fashion-web/node_modules/vue/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Work/home-fashion-web/node_modules/radix3/dist/index.mjs';
import devalue from 'file://D:/Work/home-fashion-web/node_modules/@nuxt/devalue/dist/devalue.mjs';
import robots from 'file://D:/Work/home-fashion-web/.nuxt/robots.mjs';
import { hash } from 'file://D:/Work/home-fashion-web/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Work/home-fashion-web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Work/home-fashion-web/node_modules/unstorage/drivers/fs.mjs';
import { defineHeadPlugin } from 'file://D:/Work/home-fashion-web/node_modules/@unhead/shared/dist/index.mjs';
...
const _KqtPYR14Cb = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/Work/home-fashion-web";
...
const serverAssets = [{"baseName":"server","dir":"D:/Work/home-fashion-web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Work\\home-fashion-web","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Work\\home-fashion-web\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Work\\home-fashion-web\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Work\\home-fashion-web\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Work\\home-fashion-web\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _a7Vqf891vY = defineNitroPlugin(async (nitroApp) => {
...
const _9Eo1uE = defineEventHandler(async (e) => {
...
const _YhDoIb = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _WYMQwR = defineEventHandler(async (e) => {
...
const _k7yZe0 = defineEventHandler(async (e) => {
...
const _LQr9B9 = defineEventHandler(async (e) => {
...
const _giceBN = defineEventHandler(async (event) => {
...
const _lazy_pnwelp = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_pnwelp, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _9Eo1uE, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _YhDoIb, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _WYMQwR, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _k7yZe0, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _LQr9B9, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _giceBN, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_pnwelp, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/Work/home-fashion-web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Work/home-fashion-web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
